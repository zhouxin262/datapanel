...
urlpatterns = patterns('',
    ...
    url(r'^(?P<id>\d+)/(?P<funnel_id>\d+)/action/(?P<action_id>\d+)/up/$', 'funnel.views.action.up',name='funnel_actionup'),
    url(r'^(?P<id>\d+)/(?P<funnel_id>\d+)/action/(?P<action_id>\d+)/down/$', 'funnel.views.action.down',name='funnel_actiondown'),
)

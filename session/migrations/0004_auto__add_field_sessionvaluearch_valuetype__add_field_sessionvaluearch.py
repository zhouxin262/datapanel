...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SessionValueArch.valuetype'
        db.add_column('session_sessionvaluearch', 'valuetype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['session.SessionValueType'], null=True),
                      keep_default=False)

        # Adding field 'SessionValueArch.value'
        db.add_column('session_sessionvaluearch', 'value',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding unique constraint on 'SessionValueArch', fields ['valuetype', 'session']
        db.create_unique('session_sessionvaluearch', ['valuetype_id', 'session_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SessionValueArch', fields ['valuetype', 'session']
        db.delete_unique('session_sessionvaluearch', ['valuetype_id', 'session_id'])

        # Deleting field 'SessionValueArch.valuetype'
        db.delete_column('session_sessionvaluearch', 'valuetype_id')

        # Deleting field 'SessionValueArch.value'
        db.delete_column('session_sessionvaluearch', 'value')

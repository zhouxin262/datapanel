...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Session.sn'
        db.delete_column('session_session', 'sn')

        # Adding field 'Session.session_key'
        db.add_column('session_session', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Session.sn'
        db.add_column('session_session', 'sn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, unique=True),
                      keep_default=False)

        # Deleting field 'Session.session_key'
        db.delete_column('session_session', 'session_key')

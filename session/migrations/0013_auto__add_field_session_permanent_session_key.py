...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.permanent_session_key'
        db.add_column('session_session', 'permanent_session_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.permanent_session_key'
        db.delete_column('session_session', 'permanent_session_key')

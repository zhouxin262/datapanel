...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SessionValueArch'
        db.create_table('session_sessionvaluearch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='value', to=orm['session.SessionArch'])),
        ))
        db.send_create_signal('session', ['SessionValueArch'])

        # Adding model 'SessionArch'
        db.create_table('session_sessionarch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.Project'], null=True, blank=True)),
            ...
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['session.UserAgent'], null=True)),
            ('os', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['session.UserOS'], null=True)),
            ('device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['session.UserDevice'], null=True)),
        ...
        db.send_create_signal('session', ['SessionArch'])


    def backwards(self, orm):
        # Deleting model 'SessionValueArch'
        db.delete_table('session_sessionvaluearch')

        # Deleting model 'SessionArch'
        db.delete_table('session_sessionarch')
    ...
    models = {
        ...
        'session.sessionvaluearch': {
            'Meta': {'object_name': 'SessionValueArch'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'value'", 'to': "orm['session.SessionArch']"})
        },

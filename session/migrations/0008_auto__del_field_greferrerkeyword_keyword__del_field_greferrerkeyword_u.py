...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GReferrerKeyword.keyword'
        db.delete_column('session_greferrerkeyword', 'keyword_id')

        # Deleting field 'GReferrerKeyword.user_referrer_keyword'
        db.delete_column('session_greferrerkeyword', 'user_referrer_keyword')

        # Adding field 'GReferrerKeyword.referrer_keyword'
        db.add_column('session_greferrerkeyword', 'referrer_keyword',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerKeyword', null=True, to=orm['referrer.Keyword']),
                      keep_default=False)

        # Deleting field 'GReferrerSite.site'
        db.delete_column('session_greferrersite', 'site_id')

        # Adding field 'GReferrerSite.referrer_site'
        db.add_column('session_greferrersite', 'referrer_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerSite', null=True, to=orm['referrer.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GReferrerKeyword.keyword'
        db.add_column('session_greferrerkeyword', 'keyword',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='GReferrerKeyword', to=orm['referrer.Keyword']),
                      keep_default=False)

        # Adding field 'GReferrerKeyword.user_referrer_keyword'
        db.add_column('session_greferrerkeyword', 'user_referrer_keyword',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'GReferrerKeyword.referrer_keyword'
        db.delete_column('session_greferrerkeyword', 'referrer_keyword_id')

        # Adding field 'GReferrerSite.site'
        db.add_column('session_greferrersite', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='GReferrerSite', to=orm['referrer.Site']),
                      keep_default=False)

        # Deleting field 'GReferrerSite.referrer_site'
        db.delete_column('session_greferrersite', 'referrer_site_id')

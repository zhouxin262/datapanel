...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GTime.count'
        db.alter_column('session_gtime', 'count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GTime.timelength'
        db.alter_column('session_gtime', 'timelength', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GTime.track_count'
        db.alter_column('session_gtime', 'track_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GTime.count'
        db.alter_column('session_gtime', 'count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GTime.timelength'
        db.alter_column('session_gtime', 'timelength', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GTime.track_count'
        db.alter_column('session_gtime', 'track_count', self.gf('django.db.models.fields.IntegerField')())

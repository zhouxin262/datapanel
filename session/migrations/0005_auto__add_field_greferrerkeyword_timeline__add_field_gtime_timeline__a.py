...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GReferrerKeyword.timeline'
        db.add_column('session_greferrerkeyword', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.Timeline'], null=True),
                      keep_default=False)

        # Adding field 'GTime.timeline'
        db.add_column('session_gtime', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.Timeline'], null=True),
                      keep_default=False)

        # Adding field 'GReferrerSite.timeline'
        db.add_column('session_greferrersite', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.Timeline'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GReferrerKeyword.timeline'
        db.delete_column('session_greferrerkeyword', 'timeline_id')

        # Deleting field 'GTime.timeline'
        db.delete_column('session_gtime', 'timeline_id')

        # Deleting field 'GReferrerSite.timeline'
        db.delete_column('session_greferrersite', 'timeline_id')

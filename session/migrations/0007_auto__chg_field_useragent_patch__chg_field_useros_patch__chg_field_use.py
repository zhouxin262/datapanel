...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('session_useragent', 'patch', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'UserOS.patch'
        db.alter_column('session_useros', 'patch', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'UserOS.patch_minor'
        db.alter_column('session_useros', 'patch_minor', self.gf('django.db.models.fields.CharField')(max_length=10))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GReferrerKeyword.count'
        db.alter_column('session_greferrerkeyword', 'count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GReferrerKeyword.timelength'
        db.alter_column('session_greferrerkeyword', 'timelength', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GReferrerKeyword.track_count'
        db.alter_column('session_greferrerkeyword', 'track_count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GReferrerSite.count'
        db.alter_column('session_greferrersite', 'count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GReferrerSite.timelength'
        db.alter_column('session_greferrersite', 'timelength', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GReferrerSite.track_count'
        db.alter_column('session_greferrersite', 'track_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GReferrerKeyword.count'
        db.alter_column('session_greferrerkeyword', 'count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GReferrerKeyword.timelength'
        db.alter_column('session_greferrerkeyword', 'timelength', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GReferrerKeyword.track_count'
        db.alter_column('session_greferrerkeyword', 'track_count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GReferrerSite.count'
        db.alter_column('session_greferrersite', 'count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GReferrerSite.timelength'
        db.alter_column('session_greferrersite', 'timelength', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'GReferrerSite.track_count'
        db.alter_column('session_greferrersite', 'track_count', self.gf('django.db.models.fields.IntegerField')())

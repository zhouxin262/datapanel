...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAgent.major'
        db.alter_column('session_useragent', 'major', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserAgent.patch'
        db.alter_column('session_useragent', 'patch', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserAgent.minor'
        db.alter_column('session_useragent', 'minor', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserAgent.family'
        db.alter_column('session_useragent', 'family', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding unique constraint on 'UserAgent', fields ['major', 'minor', 'family', 'patch']
        db.create_unique('session_useragent', ['major', 'minor', 'family', 'patch'])


        # Changing field 'UserOS.major'
        db.alter_column('session_useros', 'major', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserOS.family'
        db.alter_column('session_useros', 'family', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserOS.patch'
        db.alter_column('session_useros', 'patch', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserOS.patch_minor'
        db.alter_column('session_useros', 'patch_minor', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'UserOS.minor'
        db.alter_column('session_useros', 'minor', self.gf('django.db.models.fields.CharField')(max_length=4))
        # Adding unique constraint on 'UserOS', fields ['major', 'patch_minor', 'minor', 'family', 'patch']
        db.create_unique('session_useros', ['major', 'patch_minor', 'minor', 'family', 'patch'])


        # Changing field 'UserDevice.family'
        db.alter_column('session_userdevice', 'family', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding unique constraint on 'UserDevice', fields ['is_spider', 'is_mobile', 'family']
        db.create_unique('session_userdevice', ['is_spider', 'is_mobile', 'family'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserDevice', fields ['is_spider', 'is_mobile', 'family']
        db.delete_unique('session_userdevice', ['is_spider', 'is_mobile', 'family'])

        # Removing unique constraint on 'UserOS', fields ['major', 'patch_minor', 'minor', 'family', 'patch']
        db.delete_unique('session_useros', ['major', 'patch_minor', 'minor', 'family', 'patch'])

        # Removing unique constraint on 'UserAgent', fields ['major', 'minor', 'family', 'patch']
        db.delete_unique('session_useragent', ['major', 'minor', 'family', 'patch'])


        # Changing field 'UserAgent.major'
        db.alter_column('session_useragent', 'major', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserAgent.patch'
        db.alter_column('session_useragent', 'patch', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserAgent.minor'
        db.alter_column('session_useragent', 'minor', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserAgent.family'
        db.alter_column('session_useragent', 'family', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserOS.major'
        db.alter_column('session_useros', 'major', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserOS.family'
        db.alter_column('session_useros', 'family', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserOS.patch'
        db.alter_column('session_useros', 'patch', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserOS.patch_minor'
        db.alter_column('session_useros', 'patch_minor', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserOS.minor'
        db.alter_column('session_useros', 'minor', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserDevice.family'
        db.alter_column('session_userdevice', 'family', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'session.useragent': {
            ...
            'patch': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4'})
        },
        'session.userdevice': {
        ...
        'session.useros': {
            ...
            'minor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4'}),
            'patch': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4'}),
            'patch_minor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.project'
        db.alter_column('session_session', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['project.Project']))

    def backwards(self, orm):

        # Changing field 'Session.project'
        db.alter_column('session_session', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['project.Project']))

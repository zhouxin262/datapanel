...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('session_greferrerkeyword', 'keyword',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='GReferrerKeyword', to=orm['referrer.Keyword']),
                      keep_default=False)

        # Deleting field 'GReferrerSite.user_referrer_site'
        db.delete_column('session_greferrersite', 'user_referrer_site')

        # Adding field 'GReferrerSite.site'
        db.add_column('session_greferrersite', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='GReferrerSite', to=orm['referrer.Site']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GReferrerSite.user_referrer_site'
        db.add_column('session_greferrersite', 'user_referrer_site',
    ...
    models = {
        ...
        'session.greferrerkeyword': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'GReferrerKeyword'", 'to': "orm['referrer.Keyword']"}),
        ...
        'session.greferrersite': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'GReferrerSite'", 'to': "orm['referrer.Site']"}),
            'timelength': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'track_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'session.gtime': {

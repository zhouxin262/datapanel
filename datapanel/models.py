...
class Timeline(models.Model):
    ...
    def get_range(self):
        ...
        if self.datetype == 'hour':
            drange[1] = drange[1] + timedelta(seconds=3600)
        elif self.datetype == 'day':
            drange[1] = drange[1] + timedelta(seconds=3600 * 24)
        elif self.datetype == 'week':
            drange[1] = drange[1] + timedelta(seconds=3600 * 24 * 7)
        elif self.datetype == 'month':
            drange[1] = drange[1] + timedelta(months=1)
        return drange

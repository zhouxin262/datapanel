...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GReferrerSiteAndAction.dateline'
        db.delete_column('track_greferrersiteandaction', 'dateline')

        # Deleting field 'GReferrerSiteAndAction.datetype'
        db.delete_column('track_greferrersiteandaction', 'datetype')

        # Deleting field 'GReferrerKeywordAndAction.dateline'
        db.delete_column('track_greferrerkeywordandaction', 'dateline')

        # Deleting field 'GReferrerKeywordAndAction.datetype'
        db.delete_column('track_greferrerkeywordandaction', 'datetype')

        # Deleting field 'GAction.dateline'
        db.delete_column('track_gaction', 'dateline')

        # Deleting field 'GAction.datetype'
        db.delete_column('track_gaction', 'datetype')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GReferrerSiteAndAction.dateline'
        raise RuntimeError("Cannot reverse this migration. 'GReferrerSiteAndAction.dateline' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GReferrerSiteAndAction.datetype'
        raise RuntimeError("Cannot reverse this migration. 'GReferrerSiteAndAction.datetype' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GReferrerKeywordAndAction.dateline'
        raise RuntimeError("Cannot reverse this migration. 'GReferrerKeywordAndAction.dateline' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GReferrerKeywordAndAction.datetype'
        raise RuntimeError("Cannot reverse this migration. 'GReferrerKeywordAndAction.datetype' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GAction.dateline'
        raise RuntimeError("Cannot reverse this migration. 'GAction.dateline' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'GAction.datetype'
        raise RuntimeError("Cannot reverse this migration. 'GAction.datetype' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TrackValue.name'
        db.delete_column('track_trackvalue', 'name')

        # Adding field 'TrackValue.valuetype'
        db.add_column('track_trackvalue', 'valuetype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='value', null=True, to=orm['track.TrackValueType']),
                      keep_default=False)

        # Adding unique constraint on 'TrackValue', fields ['track', 'valuetype']
        db.create_unique('track_trackvalue', ['track_id', 'valuetype_id'])

        # Deleting field 'GValue.name'
        db.delete_column('track_gvalue', 'name')

        # Adding field 'GValue.valuetype'
        db.add_column('track_gvalue', 'valuetype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='gvalue', null=True, to=orm['track.TrackValueType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TrackValue.name'
        raise RuntimeError("Cannot reverse this migration. 'TrackValue.name' and its values cannot be restored.")
        # Deleting field 'TrackValue.valuetype'
        db.delete_column('track_trackvalue', 'valuetype_id')

        # Adding unique constraint on 'TrackValue', fields ['track', 'name']
        db.create_unique('track_trackvalue', ['track_id', 'name'])

        # Adding field 'GValue.name'
        db.add_column('track_gvalue', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Deleting field 'GValue.valuetype'
        db.delete_column('track_gvalue', 'valuetype_id')

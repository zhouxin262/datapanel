...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.referrer_site'
        db.add_column('track_track', 'referrer_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='track', null=True, to=orm['referrer.Site']),
                      keep_default=False)

        # Adding field 'Track.referrer_keyword'
        db.add_column('track_track', 'referrer_keyword',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='track', null=True, to=orm['referrer.Keyword']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.referrer_site'
        db.delete_column('track_track', 'referrer_site_id')

        # Deleting field 'Track.referrer_keyword'
        db.delete_column('track_track', 'referrer_keyword_id')

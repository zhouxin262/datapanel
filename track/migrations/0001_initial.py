...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('track_track', (
            ...
            ('referrer_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='track', null=True, to=orm['referrer.Site'])),
            ('referrer_keyword', self.gf('django.db.models.fields.related.ForeignKey')(related_name='track', null=True, to=orm['referrer.Keyword'])),
        ...
        # Adding model 'TrackValueType'
        db.create_table('track_trackvaluetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trackvaluetype', to=orm['project.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
        ))
        db.send_create_signal('track', ['TrackValueType'])
        ...
        db.create_table('track_trackvalue', (
            ...
            ('valuetype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='value', null=True, to=orm['track.TrackValueType'])),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('track', ['TrackValue'])

        # Adding unique constraint on 'TrackValue', fields ['track', 'valuetype']
        db.create_unique('track_trackvalue', ['track_id', 'valuetype_id'])
        ...
        db.create_table('track_greferrersiteandaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerSiteAndAction', to=orm['project.Project'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerSiteAndAction', to=orm['project.Action'])),
            ('referrer_site', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerSiteAndAction', null=True, to=orm['referrer.Site'])),
            ('datetype', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('dateline', self.gf('django.db.models.fields.DateTimeField')(max_length=13)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('timelength', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.create_table('track_greferrerkeywordandaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerKeywordAndAction', to=orm['project.Project'])),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerKeywordAndAction', to=orm['project.Action'])),
            ('referrer_keyword', self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerKeywordAndAction', null=True, to=orm['referrer.Keyword'])),
            ('datetype', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('dateline', self.gf('django.db.models.fields.DateTimeField')(max_length=13)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('timelength', self.gf('django.db.models.fields.IntegerField')(default=0)),
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'TrackValue', fields ['track', 'valuetype']
        db.delete_unique('track_trackvalue', ['track_id', 'valuetype_id'])

        # Deleting model 'Track'
        db.delete_table('track_track')

        # Deleting model 'TrackValueType'
        db.delete_table('track_trackvaluetype')
    ...
    models = {
        ...
        'track.track': {
            ...
            'referrer_keyword': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'track'", 'null': 'True', 'to': "orm['referrer.Keyword']"}),
            'referrer_site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'track'", 'null': 'True', 'to': "orm['referrer.Site']"}),
        ...
        'track.trackvalue': {
            ...
            'valuetype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'value'", 'null': 'True', 'to': "orm['track.TrackValueType']"})
        },

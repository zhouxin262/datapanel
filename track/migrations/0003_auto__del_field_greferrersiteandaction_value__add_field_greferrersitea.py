...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GReferrerSiteAndAction.value'
        db.delete_column('track_greferrersiteandaction', 'value')

        # Adding field 'GReferrerSiteAndAction.referrer_site'
        db.add_column('track_greferrersiteandaction', 'referrer_site',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerSiteAndAction', null=True, to=orm['referrer.Site']),
                      keep_default=False)

        # Deleting field 'GReferrerKeywordAndAction.value'
        db.delete_column('track_greferrerkeywordandaction', 'value')

        # Adding field 'GReferrerKeywordAndAction.referrer_keyword'
        db.add_column('track_greferrerkeywordandaction', 'referrer_keyword',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='GReferrerKeywordAndAction', null=True, to=orm['referrer.Keyword']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GReferrerSiteAndAction.value'
        db.add_column('track_greferrersiteandaction', 'value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'GReferrerSiteAndAction.referrer_site'
        db.delete_column('track_greferrersiteandaction', 'referrer_site_id')

        # Adding field 'GReferrerKeywordAndAction.value'
        db.add_column('track_greferrerkeywordandaction', 'value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'GReferrerKeywordAndAction.referrer_keyword'
        db.delete_column('track_greferrerkeywordandaction', 'referrer_keyword_id')

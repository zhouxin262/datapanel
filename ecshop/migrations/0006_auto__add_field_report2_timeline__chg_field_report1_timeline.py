...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report2.timeline'
        db.add_column('ecshop_report2', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.Timeline'], null=True),
                      keep_default=False)


        # Changing field 'Report1.timeline'
        db.alter_column('ecshop_report1', 'timeline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.Timeline'], null=True))

    def backwards(self, orm):
        # Deleting field 'Report2.timeline'
        db.delete_column('ecshop_report2', 'timeline_id')


        # Changing field 'Report1.timeline'
        db.alter_column('ecshop_report1', 'timeline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.GroupTime'], null=True))

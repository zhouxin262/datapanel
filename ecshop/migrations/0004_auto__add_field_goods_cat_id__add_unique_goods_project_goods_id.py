...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Goods.cat_id'
        db.add_column('ecshop_goods', 'cat_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding unique constraint on 'Goods', fields ['project', 'goods_id']
        db.create_unique('ecshop_goods', ['project_id', 'goods_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Goods', fields ['project', 'goods_id']
        db.delete_unique('ecshop_goods', ['project_id', 'goods_id'])

        # Deleting field 'Goods.cat_id'
        db.delete_column('ecshop_goods', 'cat_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ecshop_orderinfo', (
            ...
            ('dateline', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        ...
        # Adding model 'Report1'
        db.create_table('ecshop_report1', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='esc_report1', to=orm['project.Project'])),
            ...
            ('userview', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('pageview', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('goodsview', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('goodspageview', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('ordercount', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('orderamount', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('ecshop', ['Report1'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Report1'
        db.delete_table('ecshop_report1')

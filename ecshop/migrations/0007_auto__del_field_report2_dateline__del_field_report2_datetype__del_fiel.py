...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report2.dateline'
        db.delete_column('ecshop_report2', 'dateline')

        # Deleting field 'Report2.datetype'
        db.delete_column('ecshop_report2', 'datetype')

        # Deleting field 'Report1.datetype'
        db.delete_column('ecshop_report1', 'datetype')

        # Deleting field 'Report1.dateline'
        db.delete_column('ecshop_report1', 'dateline')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Report2.dateline'
        raise RuntimeError("Cannot reverse this migration. 'Report2.dateline' and its values cannot be restored.")
        # Adding field 'Report2.datetype'
        db.add_column('ecshop_report2', 'datetype',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)

        # Adding field 'Report1.datetype'
        db.add_column('ecshop_report1', 'datetype',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Report1.dateline'
        raise RuntimeError("Cannot reverse this migration. 'Report1.dateline' and its values cannot be restored.")

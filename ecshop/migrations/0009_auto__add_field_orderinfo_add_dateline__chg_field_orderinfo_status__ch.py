...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderInfo.add_dateline'
        db.add_column('ecshop_orderinfo', 'add_dateline',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'OrderInfo.status'
        db.alter_column('ecshop_orderinfo', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=1))

        # Changing field 'OrderInfo.dateline'
        db.alter_column('ecshop_orderinfo', 'dateline', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):
        # Deleting field 'OrderInfo.add_dateline'
        db.delete_column('ecshop_orderinfo', 'add_dateline')


        # Changing field 'OrderInfo.status'
        db.alter_column('ecshop_orderinfo', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'OrderInfo.dateline'
        db.alter_column('ecshop_orderinfo', 'dateline', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Report2.goods_id'
        db.delete_column('ecshop_report2', 'goods_id')

        # Adding field 'Report2.goods'
        db.add_column('ecshop_report2', 'goods',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecshop.Goods'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Report2.goods_id'
        db.add_column('ecshop_report2', 'goods_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Deleting field 'Report2.goods'
        db.delete_column('ecshop_report2', 'goods_id')

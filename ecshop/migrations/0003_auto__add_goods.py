...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ecshop_goods', (
            ...
            ('goods_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True)),
            ('goods_price', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=11, decimal_places=3)),
        ))
        db.send_create_signal('ecshop', ['Goods'])


    def backwards(self, orm):
        # Deleting model 'Goods'
        db.delete_table('ecshop_goods')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Report2'
        db.create_table('ecshop_report2', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='esc_report2', to=orm['project.Project'])),
            ...
            ('viewcount', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('sellcount', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
        ))
        db.send_create_signal('ecshop', ['Report2'])

        # Adding field 'Report1.timeline'
        db.add_column('ecshop_report1', 'timeline',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datapanel.GroupTime'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Report2'
        db.delete_table('ecshop_report2')

        # Deleting field 'Report1.timeline'
        db.delete_column('ecshop_report1', 'timeline_id')
    ...
    models = {
        ...
        'ecshop.report1': {
            ...
            'timeline': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['datapanel.GroupTime']", 'null': 'True'}),
